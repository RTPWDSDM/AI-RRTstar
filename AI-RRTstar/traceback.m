function initialpath = traceback(map,RRTree1,RRTree2,RRTree3,linktype,idx121,idx122,idx131,idx133,idx211,idx212,idx232,idx233,idx311,idx313,idx322,idx323)
% figure();
% imshow(map);
if linktype == 132
